...
- 在[211]中，Engelmann等提供了丰富的消融实验和可视化结果来展示感受野对基于聚合方法性能的影响。他们还提出了一种**扩展点卷积(DPC)**操作来聚合扩展的邻近特征，而不是K个最近邻。该操作被证明是非常有效的增加接受场，并可以很容易地集成到现有的基于聚合的网络。      <font color='red'>    **增分神器。**</font>
